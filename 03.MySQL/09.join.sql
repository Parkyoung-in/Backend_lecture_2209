...
' /* # 걸그룹의 hit_song_id와 song의 sid를 inner join  */
...
FROM song AS s						# Left
INNER JOIN girl_group AS g			# Right
...
/* # Full Outer Join  */ /* sql은 Full Outer Join이 없어서 left outer 조인 + UNION + right outer 조인으로 사용  */
